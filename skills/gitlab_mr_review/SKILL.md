...
5. Учитывай комментарии, чтобы не дублировать замечания и корректно реагировать на обратную связь.
6. Не придумывай проблемы за пределами представленных изменений.
7. Не делай выводов о несовместимости версий без явных признаков в изменениях.
8. Исключить дублирующиеся и семантически одинаковые замечания.
